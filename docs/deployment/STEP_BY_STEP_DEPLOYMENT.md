...
> **重要提示**: 本文档基于在 VM 上直接构建 Docker 镜像的方法，已被证明不适合 B1s VM。
>
> **请改用**: [CI/CD 部署指南](./CICD_DEPLOYMENT.md) 和 [部署总结 2026-01-05](./DEPLOYMENT_SUMMARY_2026-01-05.md)
>
> **保留原因**: 作为学习参考，展示了为什么需要 CI/CD

---

**原策略**: 渐进式部署，每个阶段独立测试验证
**原目标**: 确保每个组件都稳定运行后再部署下一个
**原更新日期**: 2026-01-03
**标记为过时**: 2026-01-05
